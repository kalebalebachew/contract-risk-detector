...
// If you're using lucide-react with Vite
import { Upload, FileText, AlertCircle, CheckCircle, ArrowRight } from "lucide-react"

// For a Vite project, you'll need to adjust these imports to match your component structure
// If you're using shadcn/ui, you'll need to import from your components directory
// If not, I've included simplified versions of these components below
        ...
        {result && result.analysis && (
          <CardFooter className="flex flex-col p-0">
            ...
            <div className="p-6 w-full space-y-4">
              ...
              <div
                className={`p-4 border rounded-md flex gap-2 ${
